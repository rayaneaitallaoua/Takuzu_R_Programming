  ...
  observe({
    ...
    output$gif_message <- renderUI({
      if (rule1_violated && rule2_violated ) {
        tags$img(src = "no.gif", height = "300px") # adjust as needed
      } else if (rule1_violated ) {
        tags$img(src = "false-wrong.gif", height = "300px") # adjust as needed
      } else if (rule3_violated ) {
        tags$img(src = "the-office-michael-scott.gif", height = "300px") # adjust as needed
      } else if(is_grid_half_complete && all_rules_respected ) {
        tags$img(src = "dance.gif", height = "300px") # adjust as needed
